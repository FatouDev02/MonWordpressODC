 ...
 * @package Kushak
 */
if ( !function_exists('kushak_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function kushak_category_widgets(){
        // Recent Post widget.
        register_widget('Kushak_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'kushak_category_widgets');
// Recent Post widget
if ( !class_exists('Kushak_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class Kushak_Sidebar_Category_Widget extends Kushak_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'kushak_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'kushak'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'kushak'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'kushak'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_label' => array(
                    'label'         => esc_html__('Latest Label', 'kushak'),
                    'type'          => 'text',
                    'default'          => esc_html__('Latest:', 'kushak'),
                ),
            );
            parent::__construct('kushak-category-layout', esc_html__('MP: Category Widget', 'kushak'), $opts, array(), $fields);
        }
        /**
