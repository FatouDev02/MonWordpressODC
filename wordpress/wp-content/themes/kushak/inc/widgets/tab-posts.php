...
if ( !function_exists('kushak_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function kushak_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Kushak_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'kushak_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Kushak_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Kushak_Tab_Posts_Widget extends Kushak_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'kushak_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'kushak'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'kushak'),
                    'type'           => 'heading',
                ),
                'popular_post_title' => array(
                    'label'         => esc_html__('Popular Posts Title', 'kushak'),
                    'type'          => 'text',
                    'default'          => esc_html__('Popular', 'kushak'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'kushak'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'kushak'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'kushak'),
                        'medium' => esc_html__( 'Medium', 'kushak' ),
                        'large' => esc_html__( 'Large', 'kushak' ),
                        'full' => esc_html__( 'Full', 'kushak' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'kushak'),
                    'description'   => esc_html__('Number of words', 'kushak'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'kushak'),
                    'type'          => 'heading',
                ),
                'recent_post_title' => array(
                    'label'         => esc_html__('Recent Posts Title', 'kushak'),
                    'type'          => 'text',
                    'default'          => esc_html__('Recent', 'kushak'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'kushak'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'kushak'),
                    'type'            => 'heading',
                ),
                'comments_post_title' => array(
                    'label'         => esc_html__('Comments Posts Title', 'kushak'),
                    'type'          => 'text',
                    'default'          => esc_html__('Comments', 'kushak'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'kushak'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'kushak-tabbed', esc_html__( 'MP: Tab Posts Widget', 'kushak' ), $opts, array(), $fields );
                        ...
                        <li tab-data="tab-popular" class="tab tab-popular active">
                            <a href="javascript:void(0)">
                                ...
                                <span class="fire-icon tab-icon">
                                    <?php kushak_the_theme_svg('popular'); ?>
                                </span>
                        ...
                        <li tab-data="tab-recent" class="tab tab-recent">
                            <a href="javascript:void(0)">
                                ...
                                <span class="flash-icon tab-icon">
                                    <?php kushak_the_theme_svg('flash'); ?>
                                </span>
                        ...
                        <li tab-data="tab-comments" class="tab tab-comments">
                            <a href="javascript:void(0)">
                                ...
                                <span class="comment-icon tab-icon">
                                    <?php kushak_the_theme_svg('comment-2'); ?>
                                </span>
