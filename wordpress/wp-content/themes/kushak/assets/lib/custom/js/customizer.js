...
jQuery(document).ready(function($){
    ...
    // Color Scheme
    $( '#customize-control-kushak_color_schema .color-scheme-picker input' ).on( 'change', function() {
        ...
        if ( $( this ).is( ':checked' ) ) {
            ...
            var data = {
                'action': 'kushak_color_schema_color',
    ...
    // Tygoraphy
	$('#_customize-input-kushak_heading_font').change(function(){

		var currentfont = this.value;

		var data = {
            'action': 'kushak_customizer_font_weight',
        ...
        $.post( ajaxurl, data, function(response) {
            ...
            if( response ){
                ...
                $('#_customize-input-kushak_heading_weight').empty();
                $('#_customize-input-kushak_heading_weight').html(response);
