(function ($) {
    ...
    var ajaxurl = kushak_admin.ajax_url;
    var KushakNonce = kushak_admin.ajax_nonce;

    // Category Color
    //$('#kushak-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: kushak_admin.upload_image,
            button: {
            text: kushak_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'kushak_notice_dismiss',
            '_wpnonce': KushakNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-kushak-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-kushak-notice').addClass('twp-installing');

        var data = {
            'action': 'kushak_install_plugins',
            '_wpnonce': KushakNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = kushak_admin.active
            var deactivate = kushak_admin.deactivate
